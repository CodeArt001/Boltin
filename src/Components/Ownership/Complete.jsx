...
const Complete = () => {
  ...
  return (
    <div className="h-full bg-black w-full  lg:pl-6 ">
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="text-white flex flex-col  justify-center items-center py-[25rem] ">
          <div></div>
          <div className="">
            ...
            <div className="flex flex-col  gap-2 py-14 ">
              ...
              <input
                ...
                className="border border-white placeholder:text-white rounded-2xl pl-3 py-3"
              />
            </div>
            <button
              onClick={() => handleTransfer(deviceId)}
              className="bg-[#6C5CE7] hover:bg-purple-700 text-white px-14 py-2 rounded-2xl w-full  mt-2 "
            >
              Complete Transfer
            </button>
          </div>

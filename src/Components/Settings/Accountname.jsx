...
const Accountname = () => {
  ...
  return (
    <div className="bg-white text-black dark:bg-black dark:text-white h-full flex flex-col justify-center items-center relative">
      <div></div>
      <div className="py-3">
        <img src={paulp} alt="" />
      ...
      <div className="flex flex-col relative items-center ">
        <div
          ...
          className="shadow shadow-black/20 border border-white rounded-lg  cursor-pointer w-[20rem] pl-3 py-2"
        >
          Edit profile
        </div>
      ...
      <div className="flex flex-col  relative items-center">
        <div
          ...
          className="shadow shadow-black/20 border border-white rounded-lg  cursor-pointer w-[20rem] pl-3 py-2  mt-3"
        >
          Change password
        </div>

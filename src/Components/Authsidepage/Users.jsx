  ...
  return (
    <div className="bg-white text-black dark:bg-black dark:text-white flex lg:flex-row md:flex-col flex-col lg:justify-between  ">
      <div className="relative">
        ...
        />
        <div className="">
          <p className=" text-5xl absolute lg:top-40 lg:right-140 md:bottom-160 bottom-92  m-4">
            Boltin
          </p>
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
            <h1 className="text-4xl font-bold  font-space  lg:w-140 md:w-full lg:px-0 md:px-0 px-5  ">
          ...
          <div className="absolute lg:bottom-45 bottom-10 lg:right-120 md:px-9 lg:px-0 px-6 flex flex-col">
      ...
      <div className="lg:mr-14 lg:mt-13  mt-0  md:px-5  mb-6 lg:mb-0 md:-mt-32">
        <Usercreate />
      </div>
    </div>
  );

    ...
    <div>
      <div className={`flex items-center relative   ${className}`}>
        ...
        <input
          ...
          className="border py-2 sm:py-2 md:py-2 lg:py-2 xl:py-2 rounded-lg border-white placeholder:text-white placeholder:text-xs sm:placeholder:text-sm md:placeholder:text-base lg:placeholder:text-base xl:placeholder:text-base bg-[#18181b] text-white w-full sm:w-56 md:w-80 lg:w-96 xl:w-96 pl-8  sm:pl-9 md:pl-10 lg:pl-10 xl:pl-10 text-sm sm:text-base md:text-base lg:text-base xl:text-base    "
        />
      </div>
    </div>
  );

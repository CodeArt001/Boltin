...
const Profilechanges = () => {
  ...
  return (
    <div className=" ">
      <div className="flex w-full sm:w-full justify-center text-black ">
        <div className="flex justify-between items-center  relative">
          ...
          <div className="flex flex-col items-center   ">
            ...
            <div className=" flex flex-col gap-3 text-black dark:text-white ">
              <div className="flex flex-col gap-2 ">
                ...
                <input
                  ...
                  className="placeholder:text-black dark:placeholder:text-white dark:border-white py-3 rounded-lg border border-black lg:w-[25rem] w-[23rem] md:w-[45rem]  pl-3"
                />
              </div>
              <div className="flex flex-col gap-2 text-black dark:text-white">
                ...
                <input
                  ...
                  className="placeholder:text-black dark:placeholder:text-white dark:border-white py-3 rounded-lg border border-black  pl-3"
                />
              </div>
              <div className="flex flex-col gap-2 text-black dark:text-white">
            ...
            <button
              ...
              className="bg-[#6C5CE7] hover:bg-[#6C5CE7] text-black dark:text-white px-14 py-2 rounded  mt-3"
            >
              Comfirm
            </button>
          </div>
